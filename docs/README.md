...
| 🗄️ Управление базами данных | [database](database.md) |
...
DMN-001…DMN-017 в [ROADMAP.md](../../asc-platform/ROADMAP.md); GRW-005 в [ROADMAP-GROWTH.md](../../asc-platform/ROADMAP-GROWTH.md).
