...
- Подстановка из *итогового* окружения приложения (env-уровни организации/ноды/приложения — [🌱 environments](../../../asc-platform/docs/features/environments.md)) и предпросмотр команды в UI — следующий инкремент; значения настроек уже доходят до приложения env-переменными (см. раздел настроек выше).
