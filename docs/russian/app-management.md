...
- **CLI-команды MVP**: `asc status`, `asc stats`, `asc app list|install|remove|start|stop|restart|logs|info|disk|settings` (+ алиасы `asc ls`/`asc ps` для списка), `asc service` (управление самим демоном).
