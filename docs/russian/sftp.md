...
- **Права**: выдача SFTP-доступа — право `apps.files` ([🔐 access-control](../../../asc-platform/docs/features/access-control.md)).
- **Квоты и лимиты**: ограничение размера загрузки, скорости — по тарифу/конфигу.
- **Аудит**: лог сессий и операций записи.

## 🔗 Связанные задачи

DMN-010, FE-008 в [ROADMAP.md](../../../asc-platform/ROADMAP.md).
