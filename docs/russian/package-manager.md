...
**Через демон** (DMN-053): при работающем системном демоне `asc upgrade` идёт через его unix-сокет, как и команды жизненного цикла — деревом приложений владеет демон, поэтому приложение, установленное в системное дерево, обновляется без sudo. Клонирование при этом использует git-креды демона (приватные репозитории — `sudo asc auth`), а интерактивная настройка авторизации, как в in-process-режиме, не предлагается.
...
DMN-003, DMN-018, DMN-038, DMN-040, DMN-045, DMN-046, DMN-047, DMN-048, DMN-052, DMN-053, DMN-059, REG-001, REG-002, BE-002, BE-003 в [ROADMAP.md](../../../asc-platform/ROADMAP.md); GRW-011 в [ROADMAP-GROWTH.md](../../../asc-platform/ROADMAP-GROWTH.md).
